...
namespace SpanJson.Tests
{
    public partial class DictionaryTests
    {
...
#else
            IDictionary<DictionaryKey, int> input = new Dictionary<DictionaryKey, int>(values);
#endif
        ...
        public void SerializeDeserializeEnumKeyReadOnlyDictionaryDictionaryUtf8()
        {
            ...
            ReadOnlyDictionary<DictionaryKey, int> input = new ReadOnlyDictionary<DictionaryKey, int>(dict);
#else
            ReadOnlyDictionary<DictionaryKey, int> input = new ReadOnlyDictionary<DictionaryKey, int>(new Dictionary<DictionaryKey, int>(values));
#endif
