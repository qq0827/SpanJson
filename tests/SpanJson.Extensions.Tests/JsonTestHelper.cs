...
namespace SpanJson
{
    internal static class JsonTestHelper
    {
        ...
        public static void AssertContents(string expectedValue, byte[] buffer)
        {
        ...
        public static void AssertContentsNotEqual(string expectedValue, byte[] buffer)
        {
            string value = Encoding.UTF8.GetString(buffer);
        ...
        public delegate void AssertThrowsActionUtf8JsonWriter(ref JsonWriter<byte> writer);

        public static void AssertThrows<E>(
            ref JsonWriter<byte> writer,
