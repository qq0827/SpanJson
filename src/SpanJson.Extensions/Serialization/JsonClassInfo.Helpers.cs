...
namespace SpanJson.Serialization
{
    internal partial class JsonClassInfo
    {
        ...
        private static readonly HashSet<string> s_nativelySupportedGenericCollections = new HashSet<string>(StringComparer.Ordinal)
        {
            ListGenericTypeName,
        ...
        private static readonly HashSet<string> s_nativelySupportedNonGenericCollections = new HashSet<string>(StringComparer.Ordinal)
        {
