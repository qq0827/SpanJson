...
namespace SpanJson.Serialization
{
    ...
    /// <remarks>Although bit flags are used, a given ClassType can only be one value.
    /// Bit flags are used to efficiently compare against more than one value.</remarks>
