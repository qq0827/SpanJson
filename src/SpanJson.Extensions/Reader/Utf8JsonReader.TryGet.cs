...
namespace SpanJson
{
    public ref partial struct Utf8JsonReader
    {
        ...
        public string GetComment()
        {
            ...
            {
                throw SysJsonThrowHelper.GetInvalidOperationException_ExpectedComment(TokenType);
            }
            ReadOnlySpan<byte> span = HasValueSequence ? ValueSequence.ToArray() : ValueSpan;
            return JsonReaderHelper.TranscodeHelper(span);
        }
        ...
        public bool GetBoolean()
        {
            ...
            {
                throw SysJsonThrowHelper.GetInvalidOperationException_ExpectedBoolean(TokenType);
            }
        }
        ...
        public bool TryGetByte(out byte value)
        {
            ...
            {
                throw SysJsonThrowHelper.GetInvalidOperationException_ExpectedNumber(TokenType);
            }
        ...
        public bool TryGetGuid(out Guid value)
        {
            ...
            if (span.Length == JsonSharedConstant.MaximumFormatGuidLength
