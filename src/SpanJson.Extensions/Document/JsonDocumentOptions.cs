...
namespace SpanJson.Document
{
    ...
    public struct JsonDocumentOptions
    {
        ...
        public static JsonDocumentOptions CreateDefault()
        {
            return new JsonDocumentOptions { CommentHandling = JsonCommentHandling.Skip, AllowTrailingCommas = true };
        }
        ...
        public JsonCommentHandling CommentHandling
        {
            ...
            set
            {
                ...
                {
                    ThrowHelper2.ThrowArgumentOutOfRangeException_JsonDocumentDoesNotSupportComments(ExceptionArgument.value);
                }
