    ...
    public readonly partial struct JsonElement
    {
        ...
        public ReadOnlySpan<byte> RawSpan
        {
            get
            {
                ...
                return _parent.GetRawValue(_idx, includeQuotes: true).Span;
            }
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public JsonElement GetProperty(in ReadOnlySpan<char> propertyName)
        {
            if (TryGetProperty(propertyName, out JsonElement property))
            {
                return property;
        ...
        /// </exception>
        /// <seealso cref="EnumerateObject"/>
        public JsonElement GetProperty(in ReadOnlySpan<byte> utf8PropertyName)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool TryGetProperty(in ReadOnlySpan<char> propertyName, out JsonElement value)
        {
            CheckValidInstance();
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool TryGetProperty(in ReadOnlySpan<byte> utf8PropertyName, out JsonElement value)
        {
            CheckValidInstance();
        ...
        public bool GetBoolean()
        {
            ...
            return
                ...
                throw SysJsonThrowHelper.GetJsonElementWrongTypeException(nameof(Boolean), type);
        }
        ...
        public byte[] GetBytesFromBase64()
        {
            ...
            throw SysJsonThrowHelper.GetFormatException();
        }
        ...
        public sbyte GetSByte()
        {
            ...
            throw ThrowHelper2.GetFormatException();
        }
        ...
        /// <summary>
        ///   Attempts to represent the current JSON string as a <see cref="CombGuid"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not create a CombGuid representation of values other than JSON strings.
        /// </remarks>
        /// <returns>
        ///   <see langword="true"/> if the string can be represented as a <see cref="CombGuid"/>,
        ///   <see langword="false"/> otherwise.
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="JsonValueKind.String"/>.
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool TryGetCombGuid(out CombGuid value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        ///   Gets the value of the element as a <see cref="CombGuid"/>.
        /// </summary>
        /// <remarks>
        ///   This method does not create a CombGuid representation of values other than JSON strings.
        /// </remarks>
        /// <returns>The value of the element as a <see cref="CombGuid"/>.</returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="JsonValueKind.String"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   The value cannot be represented as a <see cref="CombGuid"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        /// <seealso cref="ToString"/>
        public CombGuid GetCombGuid()
        {
            if (TryGetCombGuid(out CombGuid value))
            {
                return value;
            }
        ...
        internal ReadOnlyMemory<byte> GetPropertyRawValue()
        {
            CheckValidInstance();
        ...
        ///   string instances.
        /// </remarks>
        public bool ValueEquals(in ReadOnlySpan<byte> utf8Text)
        {
            // CheckValidInstance is done in the helper
        ...
        ///   the result of calling <see cref="GetString" />, but avoids creating the string instance.
        /// </remarks>
        public bool ValueEquals(in ReadOnlySpan<char> text)
        {
            // CheckValidInstance is done in the helper
        ...
        public ArrayEnumerator EnumerateArray()
        {
            ...
            if (tokenType != JsonTokenType.BeginArray)
            {
                throw SysJsonThrowHelper.GetJsonElementWrongTypeException(JsonTokenType.BeginArray, tokenType);
            }
        ...
        public ObjectEnumerator EnumerateObject()
        {
            ...
            if (tokenType != JsonTokenType.BeginObject)
            {
                throw SysJsonThrowHelper.GetJsonElementWrongTypeException(JsonTokenType.BeginObject, tokenType);
            }
