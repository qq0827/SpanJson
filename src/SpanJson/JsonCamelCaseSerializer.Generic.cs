    ...
    public static partial class JsonCamelCaseSerializer
    {
        ...
        public static class Generic
        {
            public static class Utf16
            {
                ...
                {
                    return JsonSerializer.Generic.Inner<T, char, IncludeNullsCamelCaseResolver<char>>.InnerSerializeToString(input);
                }
                ...
                {
                    return JsonSerializer.Generic.Inner<T, char, IncludeNullsCamelCaseResolver<char>>.InnerSerializeToCharArray(input);
                }
                ...
                {
                    return JsonSerializer.Generic.Inner<T, char, IncludeNullsCamelCaseResolver<char>>.InnerSerializeToCharArrayPool(input);
                }
                ...
                {
                    return JsonSerializer.Generic.Inner<T, char, IncludeNullsCamelCaseResolver<char>>.InnerSerializeAsync(input, writer, cancellationToken);
                }
                ...
                public static T Deserialize<T>(string input)
                {
                    ...
                    return JsonSerializer.Generic.Inner<T, char, IncludeNullsCamelCaseResolver<char>>.InnerDeserialize(input.AsSpan());
#else
                    return JsonSerializer.Generic.Inner<T, char, IncludeNullsCamelCaseResolver<char>>.InnerDeserialize(input);
#endif
                }
                ...
                {
                    return JsonSerializer.Generic.Inner<T, char, IncludeNullsCamelCaseResolver<char>>.InnerDeserializeAsync(reader, cancellationToken);
                }
            ...
            public static class Utf8
            {
                ...
                {
                    return JsonSerializer.Generic.Inner<T, byte, IncludeNullsCamelCaseResolver<byte>>.InnerSerializeToByteArray(input);
                }
                ...
                {
                    return JsonSerializer.Generic.Inner<T, byte, IncludeNullsCamelCaseResolver<byte>>.InnerSerializeToByteArrayPool(input);
                }
                ...
                {
                    return JsonSerializer.Generic.Inner<T, byte, IncludeNullsCamelCaseResolver<byte>>.InnerSerializeAsync(input, stream, cancellationToken);
                }
                ...
                {
                    return JsonSerializer.Generic.Inner<T, byte, IncludeNullsCamelCaseResolver<byte>>.InnerDeserialize(input);
                }
                ...
                {
                    return JsonSerializer.Generic.Inner<T, byte, IncludeNullsCamelCaseResolver<byte>>.InnerDeserializeAsync(stream, cancellationToken);
                }
