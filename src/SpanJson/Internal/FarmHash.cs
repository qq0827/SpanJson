// Largely based on https://github.com/neuecc/MessagePack-CSharp/blob/master/src/MessagePack/Internal/FarmHash.cs
...
namespace SpanJson.Internal
{
    ...
    public static class FarmHash
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe uint Hash32(in ReadOnlySpan<byte> span)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe ulong Hash64(in ReadOnlySpan<byte> span)
        {
            fixed (byte* p = &MemoryMarshal.GetReference(span))
            {
